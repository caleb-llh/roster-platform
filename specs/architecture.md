...
| `src/utils/` | Framework-agnostic helpers not yet homed to a layer: diffing, constraints, exports, colours, calendar, the `statsTheme` design tokens. Being dissolved by the overhaul (see [architecture-overhaul.plan.md](architecture-overhaul.plan.md)). |
